...
if !exists('g:ai_review_log_dir')
  let g:ai_review_log_dir = expand('~/.cache/vim/ai-review')
endif

if !exists('g:ai_review_chat_gpt_model')
  let g:ai_review_chat_gpt_model = 'gpt-3.5-turbo'
endif

if !exists('g:ai_review_chat_gpt_requests')
  let g:ai_review_chat_gpt_requests = [
        \ {
        \   'title': 'Find bugs',
...
autocmd User DenopsPluginPost:ai-review call ai_review#setup()
